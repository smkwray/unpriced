...
from unpaidwork.models.scenario_solver import solve_price
from unpaidwork.storage import read_json, read_parquet
...
def _write_piecewise_supply_demo(
    ...
    elements.extend([
        ...
        _text(676, 370, f"\u03b1 = 0.50", size=12, fill=INK),
        _text(810, 370, f"{delta_half:+.2f}", size=12, weight="600", fill=ACCENT),
        _text(676, 390, f"\u03b1 = 1.00", size=12, fill=INK),
